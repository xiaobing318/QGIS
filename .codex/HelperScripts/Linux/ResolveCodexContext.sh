...
Usage:
  bash .codex/HelperScripts/Linux/ResolveCodexContext.sh [--help]
  bash .codex/HelperScripts/Linux/ResolveCodexContext.sh [--config <path>] [--outputJsonPath <path>]
...
DEFAULT_SEARCH_MODE=$(config_string "$CONFIG_PATH" "DefaultSearchMode" "AllFileSystems")
