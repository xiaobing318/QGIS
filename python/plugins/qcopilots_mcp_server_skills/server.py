"""Command line entry point for QCopilots Skills MCP service.
...
def main() -> None:
    ...
    service = build_skill_service(Path(__file__).resolve().parent)
    run_mcp_server(
        name="QCopilots MCP Server Skills",
        version="0.1.0",
        tools=service.tools,
        resources=service.resources,
        prompts=service.prompts,
        default_port=DEFAULT_SERVICE_PORTS[SERVICE_ID],
        description="QCopilots Agent Skills MCP service.",
        logger=logger,
    )
