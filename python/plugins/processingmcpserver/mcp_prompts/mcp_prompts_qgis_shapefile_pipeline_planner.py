...
def register_prompt(
    ...
    def qgis_shapefile_pipeline_planner(
        ...
        return (
            ...
            "- Tools: mcp_tools_filesystem_query_entry_info, mcp_tools_filesystem_stats_directory, mcp_tools_dataset_list_files, mcp_tools_dataset_load_layers\n"
            ...
            "- Tools: mcp_tools_dataset_inspect_vector_bundle, mcp_tools_vector_check_validity_report, mcp_tools_filesystem_stats_directory\n"
            ...
            "- Tools: mcp_tools_processing_get_parameter_template, mcp_tools_processing_execute_algorithm, mcp_tools_vector_table_*\n"
            ...
            "- Tools: mcp_tools_vector_check_validity_report, mcp_tools_vector_export_dataset\n"
            "- Output: exported_shapefile_bundle。\n"
            "6) 数据处理后清理阶段 / Cleanup\n"
            "- Goal: 清理中间层、临时层和加载的输入层。\n"
            "- Checks: 清理清单完整，必要时记录移除结果与剩余风险。\n"
            "- Blocking: 清理失败时记录 warning，不回滚已完成导出。\n"
            "- Tools: mcp_tools_project_cleanup_work_layers, mcp_tools_layer_remove_batch\n"
