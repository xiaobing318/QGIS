#ifndef SE_LAYER_INTEGRITY_CHECK_H
#define SE_LAYER_INTEGRITY_CHECK_H

#include <QDialog>

#include "ui_se_layer_integrity_check.h"
...
#include <vector>
#include <string>
#include "../ui_thread/se_layer_integrity_check_thread.h"

using namespace std;

class CSE_LayerIntegrityCheckDialog : public QDialog
{
	Q_OBJECT

public:
	CSE_LayerIntegrityCheckDialog(QgisInterface* qgisInterface, QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_LayerIntegrityCheckDialog() override;
...
private:
	...
	Ui_SeLayerIntegrityCheckDialog ui;
	...
	SE_LayerIntegrityCheckThread m_Thread;
...
#endif // SE_LAYER_INTEGRITY_CHECK_H
