	...
	: QDialog(parent, fl)
{
	...
	connect(ui.Button_OpenOdata, &QPushButton::clicked, this, &CSE_LayerIntegrityCheckDialog::Button_OpenOdata_clicked);
	...
	connect(ui.lineEdit_InputDataPath, &QLineEdit::textChanged, this, &CSE_LayerIntegrityCheckDialog::on_lineEdit_InputDataPath_TextChanged);
...
CSE_LayerIntegrityCheckDialog::~CSE_LayerIntegrityCheckDialog()
{
	...
	settings.setValue(QStringLiteral("LayerIntegrityCheck/InputDataPath"), m_qstrInputDataPath, QgsSettings::Section::Plugins);
	settings.setValue(QStringLiteral("LayerIntegrityCheck/SaveLogPath"), m_qstrSaveLogPath, QgsSettings::Section::Plugins);
...
void CSE_LayerIntegrityCheckDialog::Button_OpenOdata_clicked()
{
	// 选择文件夹
	QString curPath = QCoreApplication::applicationDirPath();
...
void CSE_LayerIntegrityCheckDialog::on_lineEdit_InputDataPath_TextChanged(const QString& qstr)
{
	ui.progressBar->reset();
}
...
void CSE_LayerIntegrityCheckDialog::restoreState()
{
	...
	m_qstrInputDataPath = settings.value(QStringLiteral("LayerIntegrityCheck/InputDataPath"), QDir::homePath(), QgsSettings::Section::Plugins).toString();
	m_qstrSaveLogPath = settings.value(QStringLiteral("LayerIntegrityCheck/SaveLogPath"), QDir::homePath(), QgsSettings::Section::Plugins).toString();
