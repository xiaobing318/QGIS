#ifndef SE_LAYER_CODESTANDARDIZATION_CHECK_H
#define SE_LAYER_CODESTANDARDIZATION_CHECK_H

#include <QDialog>
#include "ui_se_layer_code_standardization_check.h"
...
#include <vector>
#include <string>
#include "../ui_thread/se_layer_code_standardization_check_thread.h"

using namespace std;

class CSE_LayerCodeStandardizationCheckDialog : public QDialog
{
	Q_OBJECT

public:
	CSE_LayerCodeStandardizationCheckDialog(QgisInterface* qgisInterface, QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_LayerCodeStandardizationCheckDialog() override;
...
private:
	...
	Ui_SeLayerCodeStandardizationCheckDialog ui;
	...
	SE_LayerCodeStandardizationCheckThread m_Thread;
...
#endif // SE_LAYER_CODESTANDARDIZATION_CHECK_H
