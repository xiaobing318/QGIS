...
static const QString sName = QObject::tr("质量检查评估子模块");
...
// 插件图标
static const QString sPluginIcon = QStringLiteral(":/vector_data_check_odata_toolbox/icons/pluginIcon.svg");
...
void QgsVectorDataCheckOdataPlugin::initGui()
{
	...
	/*****************************************************/
	mActionLayerIntegrityCheck = new QAction(QIcon(":/vector_data_check_odata_toolbox/icons/layer_integrity_check.svg"), tr("文件完整性检查"), this);
	...
	/*****************************************************/
	mActionLayerRarewordStatistics = new QAction(QIcon(":/vector_data_check_odata_toolbox/icons/feature_statistic.svg"), tr("生僻字统计"), this);
	...
	mQGisIface->addPluginToVectorMenu(tr("&质量检查评估子模块"), mActionLayerRarewordStatistics);
	mActionLayerRarewordStatistics->setEnabled(true);

	/*****************************************************/
	/* “【odata数据质量检查】-【命名规范性检查】”菜单*/
	/*****************************************************/
	mActionLayerNamingStandardizationCheck = new QAction(QIcon(":/vector_data_check_odata_toolbox/icons/naming_standardization.svg"), tr("命名正确性检查"), this);
	...
	mQGisIface->addPluginToVectorMenu(tr("&质量检查评估子模块"), mActionLayerNamingStandardizationCheck);
	...
	/*****************************************************/
	mActionLayerCodeStandardizationCheck = new QAction(QIcon(":/vector_data_check_odata_toolbox/icons/data_code_check.svg"), tr("数据编码规范性检查"), this);
	...
	mQGisIface->addPluginToVectorMenu(tr("&质量检查评估子模块"), mActionLayerCodeStandardizationCheck);
