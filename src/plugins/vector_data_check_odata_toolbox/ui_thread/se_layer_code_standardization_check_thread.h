#ifndef SE_LAYER_NAMINGSTANDARDIZATION_CHECK_THREAD_H
#define SE_LAYER_NAMINGSTANDARDIZATION_CHECK_THREAD_H
...
class SE_LayerCodeStandardizationCheckThread : public QThread
{
    Q_OBJECT

public:
    SE_LayerCodeStandardizationCheckThread(QObject *parent = 0);
    ~SE_LayerCodeStandardizationCheckThread();
...
#endif // SE_LAYER_NAMINGSTANDARDIZATION_CHECK_THREAD_H
