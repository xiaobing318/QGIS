#ifndef SE_LAYER_RAREWORD_STATISTICS_THREAD_H
#define SE_LAYER_RAREWORD_STATISTICS_THREAD_H
...
class SE_LayerRarewordStatisticsThread : public QThread
{
    Q_OBJECT

public:
    SE_LayerRarewordStatisticsThread(QObject *parent = 0);
    ~SE_LayerRarewordStatisticsThread();
...
#endif // SE_LAYER_RAREWORD_STATISTICS_THREAD_H
