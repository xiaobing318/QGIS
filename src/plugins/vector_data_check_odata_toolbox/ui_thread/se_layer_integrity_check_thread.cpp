...
void SE_LayerIntegrityCheckThread::SetThreadParams(QString qstrInputDataPath, QString qstrOutputLogPath)
{
...
void SE_LayerIntegrityCheckThread::run()
{
  ...
  if (qstrSubDir.size() == 0)
  {
    ...
    // 图层完整性检查
    err = CSE_VectorDataCheck::LayerIntegrityCheck_Odata(
