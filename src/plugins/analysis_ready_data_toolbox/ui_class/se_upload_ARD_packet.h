#ifndef SE_UPLOAD_ARD_PACKET
#define SE_UPLOAD_ARD_PACKET

#include <QDialog>

#include "commontype/se_config.h"
#include "ui_upload_ARD_packet.h"
...
class SE_UploadARDPacketDlg : public QDialog
{
	Q_OBJECT

public:
	SE_UploadARDPacketDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~SE_UploadARDPacketDlg() override;
