#ifndef SE_PACK_THEME_DISPLAY_READY_DATA
#define SE_PACK_THEME_DISPLAY_READY_DATA

#include <QDialog>

#include "commontype/se_config.h"
#include "ui_pack_theme_display_ready_data.h"
...
class SE_PackThemeDisplayReadyDataDlg : public QDialog
{
	Q_OBJECT

public:
	SE_PackThemeDisplayReadyDataDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~SE_PackThemeDisplayReadyDataDlg() override;
...
private:
	...
	Ui_PackThemeDisplayReadyDataDialog ui;
...
private:
	...
	// 获取用户对象对应的数据类型
	void GetUserDataTypeCheckStatus(vector<string>& vDataType);
};

#endif // SE_PACK_THEME_DISPLAY_READY_DATA
