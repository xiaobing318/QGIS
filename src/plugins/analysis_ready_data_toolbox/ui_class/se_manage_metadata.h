#ifndef SE_MANAGE_METADATA_DLG
#define SE_MANAGE_METADATA_DLG
...
class CSE_ManageMetaDataDlg : public QDialog
{
	Q_OBJECT

public:
	CSE_ManageMetaDataDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_ManageMetaDataDlg() override;
