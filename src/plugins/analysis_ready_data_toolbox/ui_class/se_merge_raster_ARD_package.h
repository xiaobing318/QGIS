...
#ifndef SE_MERGE_RASTER_ARD_PACKAGE_H
#define SE_MERGE_RASTER_ARD_PACKAGE_H

#include <QDialog>

#include "ui_merge_raster_gpkg.h"
#include <QString>
...
class CSE_MergeRasterARDPackageDialog : public QDialog
{
	Q_OBJECT

public:
	CSE_MergeRasterARDPackageDialog(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_MergeRasterARDPackageDialog() override;
...
#endif // SE_MERGE_RASTER_ARD_PACKAGE_H
