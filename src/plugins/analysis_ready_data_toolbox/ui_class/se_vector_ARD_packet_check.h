#ifndef SE_VECTOR_ARD_PACKET_CHECK_H
#define SE_VECTOR_ARD_PACKET_CHECK_H

#include <QDialog>

#include "ui_vector_ard_packet_check.h"
#include <QString>
...
class CSE_VectorARDPacketCheckDlg : public QDialog
{
	Q_OBJECT

public:
	CSE_VectorARDPacketCheckDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_VectorARDPacketCheckDlg() override;
...
public:
	...
	// 获取分析就绪数据包检查项
	void GetARDPacketCheckItems(VectorARDPacketCheckItems& sARDItems);
...
private:
	...
	Ui_Vector_ARD_Packet_Check_Dialog ui;
...
#endif // SE_VECTOR_ARD_PACKET_CHECK_H
