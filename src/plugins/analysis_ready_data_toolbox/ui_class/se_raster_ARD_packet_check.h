#ifndef SE_RASTER_ARD_PACKET_CHECK_H
#define SE_RASTER_ARD_PACKET_CHECK_H

#include <QDialog>

#include "ui_raster_ard_packet_check.h"
#include <QString>
...
class CSE_RasterARDPacketCheckDlg : public QDialog
{
	Q_OBJECT

public:
	CSE_RasterARDPacketCheckDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_RasterARDPacketCheckDlg() override;
...
public:
	...
	// 获取分析就绪数据包检查项
	void GetARDPacketCheckItems(RasterARDPacketCheckItems& sARDItems);
...
private:
	...
	Ui_Raster_ARD_Packet_Check_Dialog ui;
...
#endif // SE_RASTER_ARD_PACKET_CHECK_H
