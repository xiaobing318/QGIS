#ifndef SE_PACK_RASTER_THEME_ARD
#define SE_PACK_RASTER_THEME_ARD

#include <QDialog>

#include "commontype/se_config.h"
#include "ui_pack_raster_theme_ARD.h"
...
class SE_PackRasterThemeARDDlg : public QDialog
{
	Q_OBJECT

public:
	SE_PackRasterThemeARDDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~SE_PackRasterThemeARDDlg() override;
...
private:
	...
	Ui_PackRasterThemeARDDialog ui;
...
#endif // SE_PACK_RASTER_THEME_ARD
