#ifndef SE_UNPACK_RASTER_ARD_H
#define SE_UNPACK_RASTER_ARD_H

#include <QDialog>

#include "ui_unpack_raster_ARD.h"
#include <QString>
...
class CSE_UnpackRasterARDDlg : public QDialog
{
	Q_OBJECT

public:
	CSE_UnpackRasterARDDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_UnpackRasterARDDlg() override;
...
private:
	...
	Ui_Unpack_Raster_ARD_Dialog ui;
