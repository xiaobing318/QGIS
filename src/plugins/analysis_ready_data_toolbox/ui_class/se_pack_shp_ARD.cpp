...
SE_PackShpARDDlg::SE_PackShpARDDlg(QWidget* parent, Qt::WindowFlags fl)
	: QDialog(parent, fl)
{
	ui.setupUi(this);
	...
	connect(ui.Button_OK , &QPushButton::clicked, this, &SE_PackShpARDDlg::pushButton_OK_clicked);
	connect(ui.Button_Cancel, &QPushButton::clicked, this, &SE_PackShpARDDlg::pushButton_Cancel_clicked);
	
	connect(ui.pushButton_Open, &QPushButton::clicked, this, &SE_PackShpARDDlg::pushButton_Open_clicked);
	connect(ui.pushButton_OpenMetaDataFile, &QPushButton::clicked, this, &SE_PackShpARDDlg::pushButton_OpenMetaData_clicked);
	connect(ui.pushButton_Save, &QPushButton::clicked, this, &SE_PackShpARDDlg::pushButton_Save_clicked);
	connect(ui.Button_SaveLogFilePath, &QPushButton::clicked, this, &SE_PackShpARDDlg::pushButton_SaveLog_clicked);
...
SE_PackShpARDDlg::~SE_PackShpARDDlg()
{
	// 设置当前保存路径
...
void SE_PackShpARDDlg::restoreState()
{
...
void SE_PackShpARDDlg::pushButton_OpenMetaData_clicked()
{
...
void SE_PackShpARDDlg::pushButton_Save_clicked()
{
	// 选择文件夹
...
void SE_PackShpARDDlg::pushButton_OK_clicked()
{
	// 日志级别
	// 0——错误；1——信息；2——调试
	...
	connect(task, &SE_PackShpARDTask::taskFinished, this, &SE_PackShpARDDlg::onTaskFinished);
...
void SE_PackShpARDDlg::pushButton_Cancel_clicked()
{
	reject();
}

void SE_PackShpARDDlg::onTaskFinished(bool result)
{
	// 计算并打印总进度
	CalculateTotalProgress();
}

void SE_PackShpARDDlg::pushButton_SaveLog_clicked()
{
	// 选择文件夹
...
void SE_PackShpARDDlg::CalculateTotalProgress()
{
	int totalProgress = 0;
...
void SE_PackShpARDDlg::pushButton_Open_clicked()
{
...
bool SE_PackShpARDDlg::ReadMetaDataJsonFile(const string& strFile, VectorDataMetadataInfo& metaInfo)
{
	// 读取JSON文件
...
void SE_PackShpARDDlg::WriteMetaDataToJsonFile(const string& strFile, VectorDataMetadataInfo& metaInfo)
{
...
/*获取当前目录下所有子目录*/
void SE_PackShpARDDlg::GetSubDirFromFilePath(const string& strFilePath,
	vector<string>& vSubDir)
{
	// 获取当前工作目录
...
bool SE_PackShpARDDlg::CheckFileOrDirExist(const QString& qstrFileDirOrPath)
{
