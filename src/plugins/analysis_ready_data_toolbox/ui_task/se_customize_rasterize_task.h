#ifndef SE_CUSTOMIZE_RASTERIZE_TASK_H
#define SE_CUSTOMIZE_RASTERIZE_TASK_H
...
/*矢量数据栅格化任务类*/
class SE_CustomizeRasterizeTask : public QgsTask
{
    Q_OBJECT

public:

    SE_CustomizeRasterizeTask(const QString& name,
...
#endif // SE_CUSTOMIZE_RASTERIZE_TASK_H
