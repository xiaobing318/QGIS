#ifndef SE_PACK_VECTOR_THEME_ARD_TASK_H
#define SE_PACK_VECTOR_THEME_ARD_TASK_H
...
/*专题栅格分析就绪数据封装任务类*/
class SE_PackVectorThemeARDTask : public QgsTask
{
    Q_OBJECT

public:

    SE_PackVectorThemeARDTask(const QString& name,
...
#endif // SE_PACK_VECTOR_THEME_ARD_TASK_H
