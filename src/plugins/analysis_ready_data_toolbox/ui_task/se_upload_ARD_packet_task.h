#ifndef SE_UPLOAD_ARD_PACKET_TASK_H
#define SE_UPLOAD_ARD_PACKET_TASK_H
...
/*上传数据任务类*/
class SE_UploadARDPacketTask : public QgsTask
{
    Q_OBJECT

public:

    SE_UploadARDPacketTask(const QString& name,
...
#endif // SE_UPLOAD_ARD_PACKET_TASK_H
