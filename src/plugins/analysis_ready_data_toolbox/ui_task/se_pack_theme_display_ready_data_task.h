#ifndef SE_PACK_THEME_DISPLAY_READY_DATA_TASK_H
#define SE_PACK_THEME_DISPLAY_READY_DATA_TASK_H
...
/*显示就绪型数据封装任务类*/
class SE_PackThemeDisplayReadyDataTask : public QgsTask
{
    Q_OBJECT

public:

    SE_PackThemeDisplayReadyDataTask(const QString& name,
...
private:
    ...
    vector<string> m_vUserDataTypes;    // 不同用户对象的数据类型列表
...
#endif // SE_PACK_THEME_DISPLAY_READY_DATA_TASK_H
