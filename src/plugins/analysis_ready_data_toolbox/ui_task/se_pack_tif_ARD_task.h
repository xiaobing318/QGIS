#ifndef SE_PACK_TIF_ARD_TASK_H
#define SE_PACK_TIF_ARD_TASK_H
...
/*tif封装任务类*/
class SE_PackTifARDTask : public QgsTask
{
    Q_OBJECT

public:

    SE_PackTifARDTask(const QString& name,
