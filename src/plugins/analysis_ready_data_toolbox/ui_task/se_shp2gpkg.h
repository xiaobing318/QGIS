#ifndef SE_SHP2GPKG_TASK_H
#define SE_SHP2GPKG_TASK_H
...
/*矢量数据转换任务类*/
class SE_Shp2GpkgTask : public QgsTask
{
    Q_OBJECT

public:

    SE_Shp2GpkgTask(const QString& name,
...
private:
    ...
    string m_strInputPath;              // shp所在文件夹路径
