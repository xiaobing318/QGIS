#ifndef SE_LAYER_VALIDITY_CHECK_THREAD_H
#define SE_LAYER_VALIDITY_CHECK_THREAD_H
...
class SE_LayerValidityCheckThread : public QThread
{
    Q_OBJECT

public:
    SE_LayerValidityCheckThread(QObject *parent = 0);
    ~SE_LayerValidityCheckThread();
...
#endif // SE_LAYER_VALIDITY_CHECK_THREAD_H
