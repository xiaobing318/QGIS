#ifndef SE_FEATURE_ATTRIBUTE_THREAD_YTH_H
#define SE_FEATURE_ATTRIBUTE_THREAD_YTH_H
...
class SE_FeatureAttributeThreadYTH : public QThread
{
    Q_OBJECT

public:
    SE_FeatureAttributeThreadYTH(QObject *parent = 0);
    ~SE_FeatureAttributeThreadYTH();
...
#endif // SE_FEATURE_ATTRIBUTE_THREAD_YTH_H
