#ifndef SE_LAYER_VALIDITY_CHECK_H
#define SE_LAYER_VALIDITY_CHECK_H

#include <QDialog>

#include "ui_se_layer_validity_check.h"
...
#include <vector>
#include <string>
#include "../ui_thread/se_layer_validity_check_thread.h"

using namespace std;

class CSE_LayerValidityCheckDialog : public QDialog
{
	Q_OBJECT

public:
	CSE_LayerValidityCheckDialog(QgisInterface* qgisInterface, QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_LayerValidityCheckDialog() override;
...
private:
	...
	Ui_SeLayerValidityCheckDialog ui;
	...
	SE_LayerValidityCheckThread m_Thread;
...
#endif // SE_LAYER_VALIDITY_CHECK_H
