#ifndef SE_FEATURE_ATTRIBUTE_CHECK_H
#define SE_FEATURE_ATTRIBUTE_CHECK_H

#include <QDialog>


#include "ui_se_feature_attribute_check.h"
#include "vector/cse_vector_datacheck.h"
#include "../ui_thread/se_feature_attribute_check_thread.h"
#include <QString>
/*----------------GDAL--------------*/
#include <gdal.h>
#include <gdal_priv.h>
...
class CSE_FeatureAttributeCheckDialog : public QDialog
{
	Q_OBJECT

public:
	CSE_FeatureAttributeCheckDialog(QgisInterface* qgisInterface, QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~CSE_FeatureAttributeCheckDialog() override;
...
private:
	...
	Ui_SeFeatureAttributeCheckDialog ui;
	...
	SE_FeatureAttributeThread m_Thread;
...
#endif // SE_FEATURE_ATTRIBUTE_CHECK_H
