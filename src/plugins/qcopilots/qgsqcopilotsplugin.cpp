...
namespace
{
  bool isAllowedWebUiScheme( const QUrl &url )
  {
...
void QgsQCopilotsPlugin::initGui()
{
  ...
  /*
  1. 添加工具栏按钮用于显示/隐藏 QCopilots Dock
  */
  ...
  /*
  1. 添加工具栏按钮用于配置 QCopilots 服务器 URL
  */
...
void QgsQCopilotsPlugin::configureServerUrl()
{
  ...
  {
    mIface->messageBar()->pushWarning( tr( "QCopilots" ), tr( "Unsupported URL scheme for WebUI: %1. Please use http or https." ).arg( url.scheme() ) );
    return;
  }
