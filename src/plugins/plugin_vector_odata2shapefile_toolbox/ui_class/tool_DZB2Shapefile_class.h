#ifndef TOOL_DZB2SHAPEFILE_CLASS_H
#define TOOL_DZB2SHAPEFILE_CLASS_H
...
/*----------------自定义--------------*/
#include "ui_tool_DZB2Shapefile.h"
#include "base_vector_odata2shapefile.h"
#include "../ui_thread/tool_DZB2Shapefile_thread.h"
/*----------------自定义--------------*/
...
class ToolDZB2ShapefileDialog : public QDialog
{
	Q_OBJECT

public:
	ToolDZB2ShapefileDialog(QgisInterface* qgisInterface, QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~ToolDZB2ShapefileDialog() override;
...
private:
  ...
  TOOLDZB2ShapefileThread* m_pThread;
...
#pragma endregion
#endif // TOOL_DZB2SHAPEFILE_CLASS_H
