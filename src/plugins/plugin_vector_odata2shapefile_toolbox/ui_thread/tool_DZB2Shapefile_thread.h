#ifndef TOOL_DZB2SHAPEFILE_THREAD_H
#define TOOL_DZB2SHAPEFILE_THREAD_H
...
class TOOLDZB2ShapefileThread : public QThread
{
    Q_OBJECT

public:
    TOOLDZB2ShapefileThread(QObject *parent = 0);
    ~TOOLDZB2ShapefileThread();
...
#endif // TOOL_DZB2SHAPEFILE_THREAD_H
