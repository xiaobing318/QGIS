#ifndef TOOL_JBDX2SHAPEFILE_THREAD_H
#define TOOL_JBDX2SHAPEFILE_THREAD_H
...
class TOOLJBDX2ShapefileThread : public QThread
{
    Q_OBJECT

public:
    TOOLJBDX2ShapefileThread(QObject *parent = 0);
    ~TOOLJBDX2ShapefileThread();
...
#endif // TOOL_JBDX2SHAPEFILE_THREAD_H
