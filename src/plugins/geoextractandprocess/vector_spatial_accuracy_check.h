#ifndef QGS_VECTOR_SPATIAL_ACCURACY_CHECK_H
#define QGS_VECTOR_SPATIAL_ACCURACY_CHECK_H

#include <QDialog>
#include <qlabel.h>

#include "ui_vector_spatial_accuracy_check.h"
...
class QgsVectorSpatialAccuracyCheckDlg : public QMainWindow
{
	Q_OBJECT

public:
	QgsVectorSpatialAccuracyCheckDlg(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~QgsVectorSpatialAccuracyCheckDlg() override;
...
private:
	...
	// UI界面
	Ui_MainWindow_VectorSpatialAccuracyCheck ui;
...
private slots:
	...
	// 加载待检查数据
	void action_AddCheckVector_slot();
...
#endif // QGS_VECTOR_SPATIAL_ACCURACY_CHECK_H
