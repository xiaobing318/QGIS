#pragma once
#ifndef QGS_IMAGE_MAPPING_DIALOG_H
#define QGS_IMAGE_MAPPING_DIALOG_H
...
class QgsImageMappingDialog : public QDialog
{
	Q_OBJECT

public:
	QgsImageMappingDialog(QWidget* parent = nullptr, Qt::WindowFlags fl = Qt::WindowFlags());
	~QgsImageMappingDialog() override;

private:

	Ui_QgsImageMappingDlg ui;
...
private slots:
	...
	// 影像图制图— 按照规范新的流程
	void ImageMapping_StandardProcess();
...
private:
	...
	*/
	...
	// 影像图制图-图廓内要素矢量化（内图廓、外图廓、方里网、方里网刻度值等）
