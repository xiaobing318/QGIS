...
QgsImageSpatialAccuracyCheckDlg::QgsImageSpatialAccuracyCheckDlg(QWidget* parent, Qt::WindowFlags fl)
	: QMainWindow(parent, fl)
{
	...
	// 添加检查影像
	QString strIconAddCheckImagePath = curPath + "/resource/geoextractandprocess/layer-raster-add.png";
	QIcon iconAddCheckImage;
	iconAddCheckImage.addFile(strIconAddCheckImagePath);
	ui.action_AddCheckImage->setIcon(iconAddCheckImage);
	ui.toolBar->addAction(ui.action_AddCheckImage);
	...
	ui.tabWidget_CheckImage->addTab(mapCanvas_Check, tr("待检查影像数据"));
	...
	// 信号-槽响应函数
	connect(ui.action_AddCheckImage, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_AddCheckImage_slot);
	connect(ui.action_AddReferenceImage, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_AddReferenceImage_slot);
	connect(ui.action_AddReferenceVector, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_AddReferenceVector_slot);

	connect(ui.action_Exit, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_Exit_slot);

	connect(ui.action_AddCheckPoint, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_AddCheckPoint_slot);
	connect(ui.action_DeleteCheckPoint, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteCheckPoint_slot);
	connect(ui.action_DeleteAllCheckPoints, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteAllCheckPoints_slot);

	connect(ui.action_AddRefPoint, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_AddReferPoint_slot);
	connect(ui.action_DeleteRefPoint, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteReferPoint_slot);
	connect(ui.action_DeleteAllReferPoints, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteAllReferPoints_slot);

	connect(ui.action_CheckAccuracy, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_CheckAccuracy_slot);
	connect(ui.action_RejectCoarseDifferences, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::action_RejectCoarseDifferences_slot);

	connect(ui.action_ZoomInCheck, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::ZoomInCheckImage);
	connect(ui.action_ZoomOutCheck, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::ZoomOutCheckImage);
	connect(ui.action_PanCheck, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::PanCheckImage);

	connect(ui.action_ZoomInRefer, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::ZoomInReferImage);
	connect(ui.action_ZoomOutRefer, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::ZoomOutReferImage);
	connect(ui.action_PanRefer, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::PanReferImage);

	connect(ui.action_CreateReport, &QAction::triggered, this, &QgsImageSpatialAccuracyCheckDlg::CreateReport);
	//------------------------------------------------//
	// 检查图放大工具
	...
	connect(m_EmitPoint_Check, &QgsMapToolEmitPoint::canvasClicked,
		this, &QgsImageSpatialAccuracyCheckDlg::GetMouseClickedXY_Check);
	...
	connect(m_EmitPoint_Refer, &QgsMapToolEmitPoint::canvasClicked,
		this, &QgsImageSpatialAccuracyCheckDlg::GetMouseClickedXY_Refer);

	//----------------------------------------------//

	// 关联按钮
	connect(ui.pushButton_AddCheckImage, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_AddCheckImage_slot);
	connect(ui.pushButton_ZoomInCheck, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::ZoomInCheckImage);
	connect(ui.pushButton_ZoomOutCheck, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::ZoomOutCheckImage);
	connect(ui.pushButton_PanCheck, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::PanCheckImage);
	connect(ui.pushButton_AddCheckPoint, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_AddCheckPoint_slot);

	connect(ui.pushButton_DeleteCheckPoint, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteCheckPoint_slot);
	connect(ui.pushButton_DeleteAllCheckPoints, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteAllCheckPoints_slot);
	connect(ui.pushButton_AddReferenceImage, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_AddReferenceImage_slot);
	connect(ui.pushButton_AddReferenceVector, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_AddReferenceVector_slot);
	connect(ui.pushButton_ZoomInRefer, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::ZoomInReferImage);

	connect(ui.pushButton_ZoomOutRefer, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::ZoomOutReferImage);
	connect(ui.pushButton_PanRefer, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::PanReferImage);
	connect(ui.pushButton_AddRefPoint, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_AddReferPoint_slot);
	connect(ui.pushButton_DeleteRefPoint, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteReferPoint_slot);
	connect(ui.pushButton_DeleteAllReferPoints, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_DeleteAllReferPoints_slot);

	connect(ui.pushButton_CheckAccuracy, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_CheckAccuracy_slot);
	connect(ui.pushButton_RejectCoarseDifferences, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::action_RejectCoarseDifferences_slot);

	connect(ui.pushButton_CreateReport, &QPushButton::clicked, this, &QgsImageSpatialAccuracyCheckDlg::CreateReport);
...
QgsImageSpatialAccuracyCheckDlg::~QgsImageSpatialAccuracyCheckDlg()
{
...
// 加载待检查影像
void QgsImageSpatialAccuracyCheckDlg::action_AddCheckImage_slot()
{
	// 选择文件夹
	QString curPath = QCoreApplication::applicationDirPath();
	...
	if (filename.isEmpty())
	{
		QgsMessageLog::logMessage(tr("未加载待检查影像数据文件！"), tr("影像数据空间精度检查"), Qgis::Warning);
		return;
	}
	...
	// 设置显示范围
	mapCanvas_Check->setExtent(rasterLayer->extent());

	// 添加到画布图集中
	mapCanvasLayerSet_Check.append(rasterLayer);
...
// 加载参考影像数据
void QgsImageSpatialAccuracyCheckDlg::action_AddReferenceImage_slot()
{
	// 选择文件夹
	QString curPath = QCoreApplication::applicationDirPath();
	QString filename = QFileDialog::getOpenFileName(this,
...
// 加载参考矢量数据
void QgsImageSpatialAccuracyCheckDlg::action_AddReferenceVector_slot()
{
	// 选择文件夹
	QString curPath = QCoreApplication::applicationDirPath();
...
// 退出按钮
void QgsImageSpatialAccuracyCheckDlg::action_Exit_slot()
{
	this->close();
}

void QgsImageSpatialAccuracyCheckDlg::action_AddCheckPoint_slot()
{
	mapCanvas_Check->setMapTool(m_EmitPoint_Check);
}

// 删除检查点
void QgsImageSpatialAccuracyCheckDlg::action_DeleteCheckPoint_slot()
{
...
// 删除全部检查点
void QgsImageSpatialAccuracyCheckDlg::action_DeleteAllCheckPoints_slot()
{
...
void QgsImageSpatialAccuracyCheckDlg::action_AddReferPoint_slot()
{
	mapCanvas_Refer->setMapTool(m_EmitPoint_Refer);
}

void QgsImageSpatialAccuracyCheckDlg::action_DeleteReferPoint_slot()
{
	// 获取表格控件中的某一行，然后删除对应记录
	int iCurrentRow = ui.tableWidget_CheckPoint->currentRow();
	if (iCurrentRow < 0 || iCurrentRow >= ui.tableWidget_CheckPoint->rowCount())
...
void QgsImageSpatialAccuracyCheckDlg::action_DeleteAllReferPoints_slot()
{
	for (int row = ui.tableWidget_CheckPoint->rowCount() - 1; row >= 0; row--)
	{
		ui.tableWidget_CheckPoint->removeRow(row);
...
// 空间精度检查
void QgsImageSpatialAccuracyCheckDlg::action_CheckAccuracy_slot()
{
	if (mapCanvasLayerSet_Check.size() == 0)
	{
		QMessageBox msgBox1;
		msgBox1.setWindowTitle(tr("测绘地理数据预处理"));
		msgBox1.setText(tr("请加载待检查影像数据！"));
		msgBox1.setStandardButtons(QMessageBox::Yes);
		msgBox1.setDefaultButton(QMessageBox::Yes);
		msgBox1.exec();
		return;
...
// 剔除粗差重新计算
void QgsImageSpatialAccuracyCheckDlg::action_RejectCoarseDifferences_slot()
{
}

void QgsImageSpatialAccuracyCheckDlg::ZoomInCheckImage()
{
	mapCanvas_Check->setMapTool(m_ZoomInTool_Check);
}

void QgsImageSpatialAccuracyCheckDlg::ZoomOutCheckImage()
{
	mapCanvas_Check->setMapTool(m_ZoomOutTool_Check);
}

void QgsImageSpatialAccuracyCheckDlg::PanCheckImage()
{
	mapCanvas_Check->setMapTool(m_PanTool_Check);
}

void QgsImageSpatialAccuracyCheckDlg::ZoomInReferImage()
{
	mapCanvas_Refer->setMapTool(m_ZoomInTool_Refer);
}

void QgsImageSpatialAccuracyCheckDlg::ZoomOutReferImage()
{
	mapCanvas_Refer->setMapTool(m_ZoomOutTool_Refer);
}

void QgsImageSpatialAccuracyCheckDlg::PanReferImage()
{
	mapCanvas_Refer->setMapTool(m_PanTool_Refer);
}

void QgsImageSpatialAccuracyCheckDlg::GetMouseClickedXY_Check(const QgsPointXY& xy, Qt::MouseButton button)
{
...
void QgsImageSpatialAccuracyCheckDlg::GetMouseClickedXY_Refer(const QgsPointXY& xy, Qt::MouseButton button)
{
	QgsVertexMarker* pMarker = NULL;
	if (Qt::LeftButton == button)
	{
...
void QgsImageSpatialAccuracyCheckDlg::CreateReport()
{
	QString curPath = QCoreApplication::applicationDirPath();
	QString dlgTitle = "生成影像空间精度检查报告";
	...
	if (!qstrFileName.isEmpty())
	{
		...
		{
			// 增加日志信息
			QgsMessageLog::logMessage(tr("打开报告文件失败"), tr("影像数据空间精度检查"), Qgis::Critical);
		}

		fprintf(fp, "\n-----------------------------------------\n");
		fprintf(fp, "           影像数据空间精度检查报告           ");
		fprintf(fp, "\n-----------------------------------------\n");
		...
		QMessageBox msgBox;
		msgBox.setWindowTitle(tr("影像数据空间精度检查"));
		...
		QgsMessageLog::logMessage(tr("生成精度检查报告成功！"), tr("影像数据空间精度检查"), Qgis::Info);
	}
}
...
* @return 两点间的大地线距离
*/
double QgsImageSpatialAccuracyCheckDlg::CalDistanceOfTwoPoints(SE_DPoint dPoint1, SE_DPoint dPoint2, double dSemiMajorAxis, double dSemiMinorAxis)
{
	double dDistance = 0;
