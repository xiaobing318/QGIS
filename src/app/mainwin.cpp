...
#pragma region "发布版本的时候将这段代码打开:设置STARMAP_INSTALL_DIRECTORY_PREFIX环境变量"
    ...
    */
    const char* starmap_install_directory_prefix = getenv("DLHJ_INSTALL_DIRECTORY_PREFIX_V_2_03_02");
    if (starmap_install_directory_prefix == nullptr)
    {
      std::string starmap_install_directory_prefix_title = "提示：设置环境变量";
      std::string starmap_install_directory_prefix_message = "需要设置环境变量DLHJ_INSTALL_DIRECTORY_PREFIX_V_2_03_02。如果没有DLHJ_INSTALL_DIRECTORY_PREFIX_V_2_03_02这个变量，请首先创建这个环境变量，并且将其值设置为DLHJ在文件系统中的位置！";
...
#pragma region "发布版本的时候将这段代码打开:设置STARMAP_INSTALL_DIRECTORY_PREFIX环境变量"
      ...
      */
      ...
      replaceAll(var, "DLHJ_INSTALL_DIRECTORY_PREFIX_V_2_03_02", str_starmap_install_directory_prefix);
      //temp = var;
#pragma endregion
