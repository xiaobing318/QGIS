...
{
  inline constexpr const char *INSTALL_DIRECTORY_PREFIX_PLACEHOLDER = "QGIS40000_INSTALL_DIRECTORY_PREFIX_V_0_00_01";
  inline constexpr const char *INSTALL_DIRECTORY_NAME = "QGIS40000";
...
#ifdef _WIN32
  inline constexpr const char *WINDOWS_COUNTER_FILE_NAME = "QGIS40000.dll";
  inline constexpr const char *WINDOWS_LOCK_FILE_NAME = "QGIS40000.lock";
#elif defined( __linux__ ) && !defined( ANDROID )
  inline constexpr const char *LINUX_COUNTER_FILE_NAME = ".QGIS40000.dat";
  inline constexpr const char *LINUX_LOCK_FILE_NAME = ".QGIS40000.lock";
#endif
