...
// 将UTF-8字符串转换为宽字符串
std::wstring file_or_directory_check::files_check::UTF8ToWideChar(const std::string& str)
{
...
// 将宽字符串转换为GBK编码的字符串
std::string file_or_directory_check::files_check::WideCharToGBK(const std::wstring& wstr)
{
