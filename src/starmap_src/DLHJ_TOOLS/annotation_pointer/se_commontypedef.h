#ifndef STAREARTH_GEOEXTRACTANDPROCESS_COMMONTYPE_H_
#define STAREARTH_GEOEXTRACTANDPROCESS_COMMONTYPE_H_
...
/*基本数据类型定义*/
typedef signed __int64 SE_Int64;		// 64位有符号整型
...
#endif // STAREARTH_GEOEXTRACTANDPROCESS_COMMONTYPE_H_