	...
	vector<int>& vFieldPrecision)
{
  ...
  // 向所有类型的图层添加一个“图号”字段：字段名称，字段类型，字段长度
	vFieldsName.push_back("shet_num");
	vFieldType.push_back(OFTString);
