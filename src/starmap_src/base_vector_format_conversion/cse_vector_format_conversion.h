#ifndef CSTAREARTH_VECTOR_FORMAT_CONVERSION_H_
#define CSTAREARTH_VECTOR_FORMAT_CONVERSION_H_
...
public:
	CSE_VectorFormatConversion(void);
...
#pragma endregion
	...
	*/
	...
	/*@brief 注记指针反向挂接
	*
	* 注记指针反向挂接，包括：（1）注记层和实体层的关键属性双向挂接和标记、
	*						  （2）实体要素层的数据去重处理、
	*						  （3）双语注记的属性融合处理
	*
	* @param szInputPath:				odata单图幅路径：如:/DN1050
...
#endif // CSTAREARTH_VECTOR_FORMAT_CONVERSION_H_
