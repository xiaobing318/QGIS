...
void CSE_CalArea::SetEllipsePara(double a,double b)
{
	mSemiMajor = a;
	mSemiMinor = b;
...
double CSE_CalArea::GetQ( double x )
{
	double sinx, sinx2;
...
double CSE_CalArea::GetQbar( double x )
{
	double cosx, cosx2;
...
void CSE_CalArea::ComputeAreaInit()
{
...
double CSE_CalArea::ComputePolygonArea( double *padX, double* padY,int nCount )
{
	double x1, y1, dx, dy;
	double Qbar1, Qbar2;
