 ...
 * 	返回　－　虚拟文件包 句柄
 */
HANDLE64_PTP sfp_write_memory(HANDLE64_PTP handle, PCHAR name, PCHAR buff, uint32_t buff_size, const char *private_key, uint32 private_key_len, 
 ...
 * 	返回　－　True、False
 */
BOOL sfp_write_memory_save_file(HANDLE64_PTP handle, PCHAR filename, uint32 version, uint32 *status);
