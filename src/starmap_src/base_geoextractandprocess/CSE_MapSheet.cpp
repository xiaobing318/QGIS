...
void CSE_MapSheet::get_name_from_bbox(
	double scale,
	string map_type,
	double lon_min,
	double lat_min,
...
string CSE_MapSheet::_gb2012_to_gjb2008_500k_250k_100k(string gb_name,string map_type)
{
	...
	else
	{
		...
		int iZeroCount = seq_len - str_jb_seq.length();
		string strZero;
...
string CSE_MapSheet::_gb2012_to_gjb2008_50k_25k_10k_5k(string gb_name, string map_type)
{
	...
	int iRowZeroCount = 3 - str_father_gb_row_num.length();
	...
	int iColZeroCount = 3 - str_father_gb_column_num.length();
...
void CSE_MapSheet::_calculate_bbox(
	double lon_left,
	double lat_bottom,
	double scale,
	int row,
